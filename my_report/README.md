...
--> Εργασία για το μάθημα Διαδραστική Σχεδίαση που αφορά την επαυξημένη πραγματικότητα.

# Summary

--> Σε αυτή τη γραπτή αναφορά έχει σημειωθεί όλη η πρόοδος της εργασίας ή οποία χωρίζεται σε τρία παραδοτέα (deliverables) τα οποία αφορόυν την εξοικείωση με την επαυξημένη πραγματικότητα χρησιμοποιώντας markers, javascript και την γεωγραφική θέση.
...
--> Έχοντας ολοκληρώσει πλέον την εργασία μπορώ να πω πως έχω εξοικειωθεί αρκετά καλα με το περιβάλλον της επαυξημένης πραγματικότητας στο web, έμαθα να χρησιμοποιώ και να φτιάχνω δικά μου markers δημιουργώντας τρισδιαστατα μοντέλα και να τα ελέγχω γράφοντας σε javascript ή να τα διαχειρίζομαι μέσω των τοποθεσιών. Πράγματα που ήταν πολύ ενδιαφέρον. Επιπλέον, το γεγονός οτι είχα την ελευθερία να κάνω τα ζητούμενα της εργασίας με τον τρόπο που επιθυμώ εγώ και να διαλέγω την θεματική ενότητα του κάθε παραδοτέου όπως την ήθελα εγώ, ήταν εξαιρετικά καλό. Όπως για παράδειγμα στο 3ο παραδοτέο είχα την ελευθερία να δώσω μια συγκεκριμένη θεματική ενότητα που μου αρέσει (αυτοκίνητα) αλλα παράλληλα μπορούσα να εκπληρώσω όλα τα ζητούμενα της άσκησης. Τέλος μπορώ να πω πως πέρασα πολύ καλά κάνοντας αυτή την εργασία.
